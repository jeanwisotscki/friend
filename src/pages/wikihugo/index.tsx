...
export default function WikiHugo() {
  return (
    <>
      <Head>
        <title>Hugo Defante | WikiHugo</title>
      </Head>
        ...
        <Atom.MainContainer>
          ...
          <Atom.MainContentWrapper>
            ...
            <Atom.Resume>
              ...
              <p>
                Influenciado pelos metais pesados de <strong>Slayer</strong> e
                os teclados sintetizados de <strong>Iron Maiden</strong>, Hugo é
                conhecido por ser um dos precursores do chamado{" "}
                <strong>Synth Metal</strong> no Rio de Janeiro, gênero que
                envolve heavy metal com elementos de música eletrônica.
              </p>

              <p>
                Junto ao seu irmão <strong>Diogo Defante</strong>, também
                tornou-se um dos pioneiros do <strong>Robson Metal</strong>, com
                a temática humorística de suas letras e com os sons dúvidosos do
                seu berrante criando a atmosférica bem-humorada das canções.
                Seguindo estes estilos, ele ajudou a popularizar o{" "}
                <strong>berrante</strong>{" "}
                <i>
                  (espécie de buzina usada desde a antiguidade por pastores de
                  ovelhas e gados)
                </i>{" "}
                dentro do heavy metal em geral e veio a ser o primeiro
                guitarrista a tocar esse instrumento em um show para milhares de
                pessoas. Hugo também já foi considerado o guitarrista mais
                rápido do Velho Oeste.
              </p>
              <p>
            ...
            <Atom.History>
              ...
              <p>
                ...
                Quisquam provident quam quibusdam accusamus voluptatibus.
                Sapiente, veritatis qui quos eligendi eum est, dicta, placeat ut
                ipsa eos accusamus commodi. Quibusdam eveniet temporibus
                reprehenderit provident labore distinctio ipsa fugit eius.
                Voluptatibus ipsum, laudantium soluta eius amet, facilis ut
                doloremque harum odio fugiat non ad culpa animi debitis maxime
                similique perferendis id nobis vero cum, enim ullam? Eveniet,
                quod! Ullam facere voluptatibus quos animi ipsa recusandae harum
                iusto at nulla totam esse nostrum iure molestiae accusamus,
                distinctio temporibus adipisci iste illum dolorum eligendi!
              </p>
              ...
              <p>
                ...
                quidem laboriosam totam est quae dicta, repellat iusto quas,
                animi odio corrupti, nulla adipisci fugit reiciendis recusandae
